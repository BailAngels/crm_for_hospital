...
class PatientCard(models.Model):
    ...
    gender = models.CharField(max_length=10, choices=GenderChoices.choices, verbose_name='пол')
...
class DiseaseHistory(models.Model):
    patient_cart = models.ForeignKey(PatientCard, on_delete=models.CASCADE, related_name='disease_history')
    doctor = models.ForeignKey(Doctor, on_delete=models.SET_NULL, null=True, related_name='dis_history')
